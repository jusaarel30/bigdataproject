...
def drawgraph(df_w, df_s):
    ...
    print(df_s['Vakavuusko'].value_counts()[0])
    print(df_s['Vakavuusko'].value_counts()[1])
    print(df_s['Vakavuusko'].value_counts()[2])
    plt.savefig('summer.png')

    df_w['Vakavuusko'].value_counts().plot("bar")
    print(df_w['Vakavuusko'].value_counts()[0])
    print(df_w['Vakavuusko'].value_counts()[1])
    print(df_w['Vakavuusko'].value_counts()[2])
